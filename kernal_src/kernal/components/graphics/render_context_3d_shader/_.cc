...
render_context_3d_shader::render_context_3d_shader() {
    related_value_ = new uint32_t();
}

render_context_3d_shader::~render_context_3d_shader() {
    render_context_3d_shader::dispose();
}

bool render_context_3d_shader::is_useable() {
    ...
    struct __task__ {
        ...
        void run(barrel_buffer*) {
            ...
            if (context_) {
                ...
                context_->data_->delete_shader(*v_);
            }
            delete v_;
        }
    };

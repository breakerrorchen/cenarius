...
void render_context_2d::create_radial_gradient(js_parameter& parameter) {
    // auto thread_related = related_thread::obtain();
    // assert(thread_related);
    // if (parameter.get_argument_count() == 6) {
    //     auto x0 = parameter[0].to_float();
    //     auto y0 = parameter[1].to_float();
    //     auto r0 = parameter[2].to_float();
    //     auto x1 = parameter[3].to_float();
    //     auto y1 = parameter[4].to_float();
    //     auto r1 = parameter[5].to_float();
    ...
    //         if (_instance) {
    //             _instance->build_radial(x0, y0, r0, x1, y1, r1);
    //         }
    //     }

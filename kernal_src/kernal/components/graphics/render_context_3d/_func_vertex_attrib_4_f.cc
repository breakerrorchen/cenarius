 ...
 */
void render_context_3d::vertex_attrib_4_f(js_parameter& _parameter) {
    ...
    auto v3 = _parameter[4].to_float();
    attrib_data[0] = v0; attrib_data[1] = v1;
    attrib_data[2] = v2; attrib_data[3] = v3;

 ...
 */
void render_context_3d::disable_vertex_attrib_arr(js_parameter& _parameter) {
    ...
    context_cache_.attrib_pointer_[index].enable_ = false;
    struct __task__ {
        ...
        void run(barrel_buffer*) {
            ...
            assert(raw_context);
            raw_context->disable_vertex_attr_arr(index_);
        }
    };

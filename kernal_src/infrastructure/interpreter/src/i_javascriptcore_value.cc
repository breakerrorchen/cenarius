...
#define i_value_create_typed_arr(func_name, jsc_typed_arr_t)                \
    ...
    i_value_create_typed_arr(create_typed_arr_int16,   kJSTypedArrayTypeInt16Array       )
    i_value_create_typed_arr(create_typed_arr_int32,   kJSTypedArrayTypeInt32Array       )
    i_value_create_typed_arr(create_typed_arr_uint8,   kJSTypedArrayTypeUint8ClampedArray)
    i_value_create_typed_arr(create_typed_arr_uint16,  kJSTypedArrayTypeUint16Array      )
    i_value_create_typed_arr(create_typed_arr_uint32,  kJSTypedArrayTypeUint32Array      )
    i_value_create_typed_arr(create_typed_arr_float32, kJSTypedArrayTypeFloat32Array     )
    i_value_create_typed_arr(create_typed_arr_float64, kJSTypedArrayTypeFloat64Array     )

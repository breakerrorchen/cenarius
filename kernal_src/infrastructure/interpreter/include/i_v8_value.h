...
private:
    i_value(Local<Context> context, Local<Value> value) {
        context_._$_ = context; _$_ = value;
...
public:
    ...
    inline bool is_useable() const { 
        return !_$_.IsEmpty() && context_.is_useable(); 
    }
...
public:
    ...
    i_value function_invoke(
        const i_object*, const i_value*, int, i_value*) const;
